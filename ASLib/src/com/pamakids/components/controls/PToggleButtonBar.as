package com.pamakids.components.controls
{
	...
	public class PToggleButtonBar extends Container
	{
		...
		{
			super(width, height);
			this.dataProvider=dataProvider;//如果不存呢?
		...
		override protected function init():void
		{
			...
			{
				var oneButton:PToggleButton=new PToggleButton(o.name/*, o.selected, o.required*/);
				buttons.push(oneButton);
				//oneButton.addEventListener(MouseEvent.CLICK, onClick);
				oneButton.centerFill=true;
				layout.addItem(oneButton);
			}
		}
